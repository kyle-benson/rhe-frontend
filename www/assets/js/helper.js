...
var Helper = {
	 bindListView: function (listviewComponent, dataArray, itemRenderFunction, keyField, bottompage) {
			...
			for (var i=0; i<dataArray.length; i++){
				...
				if(bottompage)
					var _html = "<li data-icon='false' keyField='" + _keyField + "'><a href='#'>" + itemRenderFunction(dataArray[i]) + "</a></li>\n";
				else				
					var _html = "<li keyField='" + _keyField + "'><a href='#'>" + itemRenderFunction(dataArray[i]) + "</a></li>\n";
